...
var _alphabetCharCodeArrJs = require("./src/static/alphabetCharCodeArr.js");
var _alphabetCharCodeArrJsDefault = parcelHelpers.interopDefault(_alphabetCharCodeArrJs);
var _caesarCipherJs = require("./src/static/caesarCipher.js");
var _caesarCipherJsDefault = parcelHelpers.interopDefault(_caesarCipherJs);
var _numStrToCharStrJs = require("./src/static/numStrToCharStr.js");
var _numStrToCharStrJsDefault = parcelHelpers.interopDefault(_numStrToCharStrJs);
var _isNumOpJs = require("./src/static/isNumOp.js");
var _isNumOpJsDefault = parcelHelpers.interopDefault(_isNumOpJs);
var _copyResultJs = require("./src/static/copyResult.js");
var _copyResultJsDefault = parcelHelpers.interopDefault(_copyResultJs);
$(document).ready(()=>{
   ...
   */ // initialize example tooltip for copying
    ...
    exampleTestText.on("click", ()=>{
        (0, _copyResultJsDefault.default)(exampleTestText.text());
    ...
    resultText.on("click", ()=>{
        (0, _copyResultJsDefault.default)(resultText.text());
    ...
    $("#cipher-form").on("submit", (e)=>{
       ...
       */ if ((0, _isNumOpJsDefault.default)(textInput)) {
                // get the string from the character codes
                const strVals = (0, _numStrToCharStrJsDefault.default)(textInput);
                // call the function to decrypt
                const numResult = (0, _caesarCipherJsDefault.default)(strVals, shiftVal, true);
                resultText.text(numResult);
            } else {
                const strResult = (0, _caesarCipherJsDefault.default)(textInput, shiftVal, true);
            ...
            const encryptedRes = (0, _caesarCipherJsDefault.default)(textInput, shiftVal);
            // convert to nums if so chosen
            if (outputType === "numbers") {
                // call function to return num string
                const encryptedNumsRes = (0, _alphabetCharCodeArrJsDefault.default)(encryptedRes);
                // return result
...
},{"./src/static/alphabetCharCodeArr.js":"3jKGG","./src/static/caesarCipher.js":"47Bqh","./src/static/numStrToCharStr.js":"MqmTg","./src/static/isNumOp.js":"eOeXN","./src/static/copyResult.js":"3ko91","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3jKGG":[function(require,module,exports) {
/** function that gives another layer of
 *  encryption that lets you convert a string cipher
 *  to a sequence of numbers
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>alphabetCharCodeArr);
function alphabetCharCodeArr(str) {
...
},{}],"47Bqh":[function(require,module,exports) {
// func to decrypt and decrypt strings
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>caesarCipher);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"MqmTg":[function(require,module,exports) {
/** function that decrypts the num string output
 *  back into a string format
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>numStrToCharStr);
function numStrToCharStr(numStr) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eOeXN":[function(require,module,exports) {
 ...
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>isNumOp);
function isNumOp(input) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3ko91":[function(require,module,exports) {
// helper function to let user copy the final output
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>copyResult);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["km5uZ","bB7Pu"], "bB7Pu", "parcelRequirec659")
